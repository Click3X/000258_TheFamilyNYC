...
jQuery(document).ready(function($) {
	...
	var coords = [
		...
		[222, 184, 284, 192, "stripe-tri", "left"],
		[162, 139, 188, 324, "stripe-tri", "half"],
		[136, 110, 830, -20, "gold-foli", "reflect"],
		[107, 88, 345, 444, "stripe-tri", "reflect"],
		[167, 135, 265, 490, "gold-foil", "reflect"],
		[109, 90, 306, 808, "stripe-tri", "reflect"],
	...
	$.each(coords, function(i, elem) {
		...
		coords.push( [ coords[i][0], coords[i][1], coords[i][2], coords[i][3] , coords[i][4], coords[i][5] ] );
	});
	...
	function blob(count) {
		...
		this.element = $('<div/>', { 'class':'tri '+ coords[count][4]});
		...
		this.startTop = (coords[count][3]/1000) * 100;
