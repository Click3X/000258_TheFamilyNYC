...
<?php get_header(); ?>
			...
			<div id="content" class="clearfix">
				...
				<h1>Address</h1>
				<br />
				<p>54 West 21st Street, Room 508<br /> NYC, NY 10010<br />Tel: 212 477 4278<br />Email: <a class="boldlink" href="mailto:reps@thefamilynyc.com">reps@thefamilynyc.com</a></p>
				<br /><br />
				...
				<p><span class="green">C: </span> 917.697.1515</p>
				<p><a href="mailto:diane@thefamilynyc.com">diane@thefamilynyc.com</a></p>
				<br />
				<!--<p id="name">Chris Zander</p>
				<p id="tite">BROTHER</p>
				<p><span class="green">T: </span> 212.477.4278</p>
				<p><span class="green">C: </span> 914.572.8186</p>
				<p><a href="mailto:chris@thefamilynyc.com">chris@thefamilynyc.com</a></p>
				<br />-->
				<p id="name">Anna Rotholz</p>
				<p id="tite">SISTER</p>
				<p><span class="green">T: </span> 212.477.4278</p>
				<p><span class="green">C: </span> 914.588.6450</p>
