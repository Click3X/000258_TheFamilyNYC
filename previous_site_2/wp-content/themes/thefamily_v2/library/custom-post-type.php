...
function custom_post_example() { 
	...
	register_post_type( 'large_video', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Large Videos', 'post type general name'), /* This is the Title of the Group */
			'singular_name' => __('Large Video', 'post type singular name'), /* This is the individual type */
	...
	register_taxonomy_for_object_type('category', 'large_video');
	/* this ads regular tags to your custom post type */
	register_taxonomy_for_object_type('post_tag', 'large_video');
    ...
    register_taxonomy( 'custom_cat', 
    	array('large_video'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
    ...
    // let's create the function for the custom type
    function custom_post_fridge() { 
    	// creating (registering) the custom type 
    	register_post_type( 'family_fridge', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
    	 	// let's now add all the options for this post type
    		array('labels' => array(
    			'name' => __('Family Fridge', 'post type general name'), /* This is the Title of the Group */
    			'singular_name' => __('Family Fridge', 'post type singular name'), /* This is the individual type */
    			'add_new' => __('Add New', 'custom post type item'), /* The add new menu item */
    			'add_new_item' => __('Add New Custom Type'), /* Add New Display Title */
    			'edit' => __( 'Edit' ), /* Edit Dialog */
    			'edit_item' => __('Edit Post Types'), /* Edit Display Title */
    			...
    			'description' => __( 'Family Fridge Archive' ), /* Custom Type Description */
    			'public' => true,
    			'publicly_queryable' => true,
    			'exclude_from_search' => false,
    			'show_ui' => true,
    	...
    	/* this ads regular categories to your custom post type */
    	register_taxonomy_for_object_type('category', 'family_fridge');
    	/* this ads regular tags to your custom post type */
    	register_taxonomy_for_object_type('post_tag', 'family_fridge');
    	
    } 
    
    	// adding the function to the Wordpress init
    	add_action( 'init', 'custom_post_fridge');
    	
    	// now let's add custom categories (http://codex.wordpress.org/Function_Reference/register_taxonomy)
        register_taxonomy( 'custom_cat', 
        	array('family_fridge'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
        	array('hierarchical' => true,                    
        		'labels' => array(
        			'name' => __( 'Custom Categories' ), /* name of the custom taxonomy */
        			'singular_name' => __( 'Custom Category' ), /* single taxonomy name */
