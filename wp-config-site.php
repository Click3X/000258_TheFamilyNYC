...
define('DB_NAME', 'thefamily15');

/** MySQL database username */
define('DB_USER', 'thefamily15');

/** MySQL database password */
define('DB_PASSWORD', 'CeDrEph5!');

/** MySQL hostname */
// define('DB_HOST', 'familynycwp.db.7573293.hostedresource.com');
define('DB_HOST', 'thefamily15.db.7573293.hostedresource.com');
